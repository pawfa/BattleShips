...
class App extends Component {
  ...
  render() {
    ...
    let disabledButton = this.state.blockedDragging
        ? 'disabled light-blue darken-1'
        : 'light-blue darken-1';
        ...
        <div className="App">
          ...
          <Row className="mainRow">
            <Col className='mainCol l5'>
              <OpponentBoard gameStatus={gameStatus}
                             opponentBoardCellStatus={opponentBoardCellStatus}/>
            </Col>
